...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
  ...
  $(function() {
	...
	<body onload="ajaxLoad()" data-spy="scroll">
		<!-- Navigation -->
	<?php
		include ("../headerfooter/header.php");
		include ("../conexion/conexion.proc.php");
        $sqlEditar = "SELECT*FROM tbl_articulo WHERE id_articulo=$_REQUEST[id]";
        $sqlEditarDatos = mysqli_query($con, $sqlEditar);
        $resultado = mysqli_fetch_array($sqlEditarDatos);
	?>
        ...
        <input type="hidden" id="articulo" name="articulo" value="<?php echo utf8_encode ($resultado['texto_articulo'])?>" />
			...
			<iframe id="form_target" name="form_target" style="display:none"></iframe>
	            <form id="my_form" action="../conexion/editarBlog.proc.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" id="articId" name="articId" value="<?php echo $_REQUEST['id'] ?>" />                    
